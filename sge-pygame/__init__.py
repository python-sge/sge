...
``sge.Sprite.draw_line`` and ``sge.Room.project_line`` support anti-
aliasing for lines with a thickness of 1 only.  ``sge.Sprite.draw_text``
and ``sge.Room.project_text`` support anti-aliasing in all cases.  No
